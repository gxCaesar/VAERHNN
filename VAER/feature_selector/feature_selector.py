...
class FeatureSelector():
    ...
    def plot_missing(self):
        ...
        sns.set_style('ticks')
        plt.hist(self.missing_stats['missing_fraction'], bins = np.linspace(0, 1, 11))
        # sns.histplot(data = self.missing_stats['missing_fraction'],bins = np.linspace(0, 1, 11))
        plt.xticks(np.linspace(0, 1, 11));
        plt.xlabel('Missing Fraction'); plt.ylabel('Count of Features'); 
        plt.title("Fraction of Missing Values Histogram", size = 15);
    ...
    def plot_unique(self):
        ...
        self.unique_stats.plot.hist()
        plt.ylabel('Frequency'); plt.xlabel('Unique Values'); 
        plt.title('Number of Unique Values Histogram', size = 15);
    ...
    def plot_feature_importances(self, plot_n = 15, threshold = None):
        ...
        # Plot labeling
        plt.xlabel('Normalized Importance'); plt.title('Feature Importances',size = 15)
        plt.savefig('images/Feature Importances.png',dpi=600,bbox_inches="tight")
        ...
        if threshold:
            ...
            plt.savefig('images/CumulativeFeatureImportance.png',dpi=600,bbox_inches="tight")
            plt.show();
