...
np.savetxt('result/results_Gru_AAC.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_PseAAC.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_ConTriad.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_Quasi-seq.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_CNN.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_Gru.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_Lstm.csv',y_pred,delimiter=',')
...
y_pred = model.predict(X_pred)
print('The predicted score is ' + str(y_pred))
np.savetxt('result/results_Gru_Transformer.csv',y_pred,delimiter=',')